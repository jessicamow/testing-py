...
def is_mel(name, email):
    """Is this user Mel?: Tests if Mel==True
    ...
    True
    >>> is_mel('Im definitely not that guy', 'mel@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type': 'appetizer'}, {'type': 'dessert'}, {'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'drink'}])
    ('appetizer', 'drink')
